...
import (
	...
	"github.com/sjy-dv/personal_medical_doctor/langchain/tools/duckduckgo/internal"
)

// DefaultUserAgent defines a default value for user-agent header.
const DefaultUserAgent = "github.com/sjy-dv/personal_medical_doctor/langchain/tools/duckduckgo"
